...
import { LayoutDashboard, Globe, MapPin, Bus, Building2, Calendar, Users, HelpCircle, PhoneCall, Settings, LogOut, Menu, X, Star, ClipboardList } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { icon: ClipboardList, label: 'Manifiesto de Despacho', href: '/admin/manifest' },
